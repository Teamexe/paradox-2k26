...
import 'package:paradox_2k26/screens copy/home_screen.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 3500), () async {
      ...
      // Forcing AuthScreen so the user can interact/bypass it for testing
      final Widget destination = const MainScreen();
